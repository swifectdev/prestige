...
Public Class maccount
    ...
    Private Sub gencode()
        '   txtcode.Text = cl.readData("SELECT dbo.fgetcode('mtype','" & Now() & "')")
    End Sub
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'maccount'") = "N" Then
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        Dim sql As String = " SELECT TA.* FROM maccount TA WHERE TA.tstatus = 1"
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode, "[maccount]maccount")
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        With cl
            ...
            Dim tny As Integer
            tny = .msgYesNo("Delete Rekening : " & txtname.Text & " ?", "Confirmation")
            If tny = vbYes Then
                .openTrans()
                .execCmdTrans(
                        "EXEC smaccount " &
                ...
                .closeTrans(btnsave)
                If .sCloseTrans = 1 Then
                    .msgInform("Success Delete Rekening : " & txtname.Text & " !", "Information")
                    changestatform("new") : End If
            End If
        End With
    End Sub
