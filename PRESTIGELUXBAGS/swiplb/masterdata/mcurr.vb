...
Public Class mcurr
    ...
    Private Sub gencode()
        '   txtcode.Text = cl.readData("SELECT dbo.fgetcode('mcurr','" & Now() & "')")
    End Sub
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mcurr'") = "N" Then
            ...
            ElseIf btnsave.Text = "Update" Then
                '----------USER AUTHORIZATION CHECK--------------'
                If .readData("SELECT canupdate from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mcurr'") = "N" Then
                    .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                    Exit Sub
                End If
                '---------------------END------------------------'
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        Dim sql As String = " SELECT TA.* FROM mcurr TA WHERE TA.tstatus = 1"
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode, "[mcurr]mcurr")
        a.loadSQLSearch(sql, 1)
        a.Text = "Pencarian Mata Uang"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        With cl
            '----------USER AUTHORIZATION CHECK--------------'
            If .readData("SELECT candelete from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mcurr'") = "N" Then
                .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                Exit Sub
            End If
            '---------------------END------------------------'
            ...
            Dim tny As Integer
            tny = .msgYesNo("Delete Mata Uang : " & txtname.Text & " ?", "Confirmation")
            If tny = vbYes Then
                .openTrans()
                .execCmdTrans(
                        "EXEC smcurr " &
                ...
                .closeTrans(btnsave)
                If .sCloseTrans = 1 Then
                    .msgInform("Success Delete Mata Uang : " & txtname.Text & " !", "Information")
                    changestatform("new") : End If
            End If
        End With
    End Sub
