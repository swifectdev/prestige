...
Public Class mbrand
    ...
    Private Sub gencode()
        '   txtcode.Text = cl.readData("SELECT dbo.fgetcode('mbrand','" & Now() & "')")
    End Sub
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mbrand'") = "N" Then
                    .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                    Exit Sub
                End If

                If cl.readData("SELECT COUNT(id) FROM mbrand where code = '" & txtcode.Text & "' and tstatus = 1") Then
                ...
                ElseIf btnsave.Text = "Update" Then
                    '----------USER AUTHORIZATION CHECK--------------'
                    If .readData("SELECT canupdate from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mbrand'") = "N" Then
                    .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                    Exit Sub
                End If
                '---------------------END------------------------'
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        Dim sql As String = " SELECT TA.* FROM mbrand TA WHERE TA.tstatus = 1"
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode, "[mbrand]mbrand")
        a.loadSQLSearch(sql, 1)
        a.Text = "Pencarian Merk"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        With cl
            '----------USER AUTHORIZATION CHECK--------------'
            If .readData("SELECT candelete from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'mbrand'") = "N" Then
                .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                Exit Sub
            End If
            '---------------------END------------------------'

            If cl.readData("SELECT COUNT(id) FROM mitem where code_mbrand = '" & txtcode.Text & "' and tstatus = 1") Then
