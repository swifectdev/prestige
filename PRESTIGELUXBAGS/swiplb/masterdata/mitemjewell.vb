...
Public Class mitemjewell
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If validatetxtnull(txtvendor, "Vendor harus di isi !", "Information") = 1 Then : Exit Sub : End If
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        Dim sql As String = " SELECT TA.*, TC.name 'name_mvendor', TC.phone 'phone_mvendor' " &
            " FROM mitem TA  " &
            " LEFT JOIN mvendor TC ON TA.code_mvendor = TC.code WHERE TA.tstatus = 1  AND TA.code_mtype = 'JW'"
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode, "[mitemjewell]mitemjewell")
    ...
    Private Sub btnvendor_Click(sender As Object, e As EventArgs) Handles btnvendor.Click
        ...
        a.loadStatusTempForm(Me, Me.txtname_mconsignee, "[mvendor]mitemjewell")
        a.loadSQLSearch(sqlStr, 1)
