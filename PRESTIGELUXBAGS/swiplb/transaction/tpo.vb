...
Public Class tpo
    ...
    Private Sub gencode()
        txtno.Text = cl.readData("BEGIN TRY SELECT dbo.fgetcode('tpo','" & Format(CDate(dttdate.Value), "yy") & "') END TRY BEGIN CATCH SELECT '' END CATCH")
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If validatetxtnull(txtcode_mcust, "Customer Harus di isi!", "Warning Information") = 1 Then : Exit Sub : End If
            If validatetxtnull(txtcode_mitem, "Item harus di isi !", "Warning Information") = 1 Then : Exit Sub : End If
            '------ end validasi
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tpo'") = "N" Then
                ...
                '----------USER AUTHORIZATION CHECK--------------'
                If .readData("SELECT canupdate from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tpo'") = "N" Then
                    .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                    Exit Sub
                End If
                '---------------------END------------------------'
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        Dim sql As String = " SELECT TA.* FROM tpo TA WHERE TA.tstatus = 1"

        With a.dgview : .DataSource = cl.table(sql)
            For i As Integer = 0 To .Columns.Count - 1 : .Columns(i).Visible = False : Next
            .Columns("no").Visible = True : .Columns("no").HeaderText = "No PO"
            .Columns("tdate").Visible = True : .Columns("tdate").HeaderText = "Tgl PO"
            .Columns("tdate2").Visible = True : .Columns("tdate2").HeaderText = "Tgl Sampai"
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode_mitem, "[tpo]tpo")
        a.loadSQLSearch(sql, 1)
        a.Text = "Pencarian Pre Order"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        With cl
            '----------USER AUTHORIZATION CHECK--------------'
            If .readData("SELECT candelete from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tpo'") = "N" Then
                .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                Exit Sub
            End If
            '---------------------END------------------------'
            ...
            Dim tny As Integer
            tny = .msgYesNo("Delete Pre Order : " & txtno.Text & " ?", "Confirmation")
            If tny = vbYes Then
                .openTrans()
                .execCmdTrans(
                      "EXEC stpo " &
                ...
                .closeTrans(btnsave)
                If .sCloseTrans = 1 Then
                    .msgInform("Success Delete Pre Order : " & txtno.Text & " !", "Information")
                    changestatform("new") : End If
            End If
        End With
    End Sub
    ...
    Private Sub btnbrowseconsignee_Click(sender As Object, e As EventArgs) Handles btnbrowseconsignee.Click
        ...
        a.loadStatusTempForm(Me, Me.txtname_mcust, "[mcust]tpo")
    ...
    Private Sub btnbrowsebrand_Click(sender As Object, e As EventArgs) Handles btnbrowsebrand.Click
        ...
        a.loadStatusTempForm(Me, Me.txtname_mcust, "[mbrand]tpo")
        a.loadSQLSearch(sqlStr, 1)
        a.Text = "Pencarian : Brand/Pre Order"
    ...
    Private Sub btnbrowsemitem_Click(sender As Object, e As EventArgs) Handles btnbrowsemitem.Click
        ...
        End With
        a.loadStatusTempForm(Me, Me.txtcode_mitem, "[mitem]tpo")
        a.loadSQLSearch(sql, 1)
