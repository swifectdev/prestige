...
Public Class tps
    ...
    Private Sub gencode()
        txtno.Text = cl.readData("SELECT dbo.fgetcode('tps','" & Format(CDate(dttdt.Text), "yy") & "')")
    End Sub
    ...
    Private Sub btnsave_Click(sender As System.Object, e As System.EventArgs) Handles btnsave.Click
        With cl
            ...
            If btnsave.Text = "Save" Then
                ...
                If .readData("SELECT canadd from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tps'") = "N" Then
                ...
                If .readData("SELECT COUNT(id) FROM tps WHERE no = '" & txtno.Text & "' AND tstatus = 1") > 0 Then
            ...
            ElseIf btnsave.Text = "Update" Then
                '----------USER AUTHORIZATION CHECK--------------'
                If .readData("SELECT canupdate from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tps'") = "N" Then
                    .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                    Exit Sub
                End If
                '---------------------END------------------------'
                ...
                .closeTrans(btnsave)
                If .sCloseTrans = 1 Then
                    .msgInform("Success Update Payment ke Vendor : " & txtno.Text & " !", "Information")
                    changestatform("new") : End If
            End If
            'End If
        End With
    ...
    Private Sub btnlist_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlist.Click
        ...
        sqlStr =
            "SELECT T0.* " &
            " FROM tps T0 WHERE T0.tstatus = 1 " & sqlwhere
        ...
        a.loadStatusTempForm(Me, Me.btnlist, "[tps]tps")
        a.loadSQLSearch(sqlStr, 1)
        a.Text = "Pencarian : Payment ke Vendor"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        With cl
            '----------USER AUTHORIZATION CHECK--------------'
            If .readData("SELECT candelete from cusrpriv WHERE id_cusr = '" & idusr & "' AND code_capp = 'tps'") = "N" Then
                .msgError("User tidak dapat melakukan tindakan ini ! Mohon untuk check setting otorisasi !", "Informasi")
                Exit Sub
            End If
            '---------------------END------------------------'
            ...
            If tny = vbYes Then
                ...
                .closeTrans(btnsave)
                If .sCloseTrans = 1 Then
                    .msgInform("Sukses menghapus Payment ke Vendor : " & txtno.Text & " !", "Informasi")
                    changestatform("new") : End If
            End If
        End With
    End Sub
    ...
    Private Sub btnbrowsecust_Click(sender As Object, e As EventArgs) Handles btnbrowsecust.Click
        ...
        a.loadStatusTempForm(Me, Me.txtname_mcust, "[mvendor]tps")
        a.loadSQLSearch(sqlStr, 1)
    ...
    Private Sub btnbrowsecoa_Click(sender As Object, e As EventArgs) Handles btnbrowsecoa.Click
        ...
        a.loadStatusTempForm(Me, Me.txtname_mcust, "[maccount]tps")
        a.loadSQLSearch(sqlStr, 1)
